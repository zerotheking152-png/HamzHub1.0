...
-- Config window dulu, tapi visibility false awal
local Window = Rayfield:CreateWindow({
   Name = "HamzHub - Fish It!",
   LoadingTitle = "Loading HamzHub...",
   LoadingSubtitle = "by Email | Fish It! Auto Farm",
   ConfigurationSaving = {
      Enabled = true,
      FolderName = "HamzHub",
      FileName = "Config"
   ...
   KeySystem = false,
   Theme = "Emerald", -- Hijau kuning theme
   ToggleUIKeybind = "RightShift" -- Hotkey buat toggle UI muncul/hilang (ganti kalau mau)
})

-- Mulai hidden, harus tekan tombol dulu
